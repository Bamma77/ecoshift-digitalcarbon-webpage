...
function updateChecklist() {
  ...
  if (checked === 0) {
    ...
    msg =
      "시작이 좋습니다! 체크한 습관부터 꾸준히 유지하면 디지털 탄소를 조금씩 줄일 수 있어요.";
  } else if (checked <= 6) {
    msg =
      "이미 여러 가지 좋은 습관을 실천 중입니다. 주변 사람들에게도 팁을 나눠보면 어떨까요?";
  } else {
    msg =
      "훌륭해요! 디지털 탄소중립 실천러입니다. 이제는 다른 영역(오프라인 에너지, 이동수단 등)까지 확장해 보아도 좋겠습니다.";
  }
